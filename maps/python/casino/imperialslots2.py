...
#NonStandard type Imperial Slots
...
minpot = 1500 #Minimum slot jackpot size
maxpot = 10000 #Maxiumum slot jackpot size
cost = 3 #Price of usage

#Change the items on the slot spinner or the number of items.
slotlist = ["ChineseDragon", "ElectricDragon", "RedDragon", "ChaosDragon", "House", "Castle", "Palace", "ULTRA"]
    ...
    if (pay):
       ...
       for item in results:
          ...
          if results.count(item) == spinners-1:
             if item == "ChineseDragon":
                pay = 1
             elif item == "ElectricDragon":
                pay = 2
             elif item == "RedDragon":
                pay = 3
             elif item == "ChaosDragon":
                pay = 4
             elif item == "House":
                pay = 5
             elif item == "Castle":
