...
#define MAP_FORMAT  "antarcticworld_%03d_%03d"
...
char *Terrain_Names[][2] = {
     ...
     */
    {"None",	    "0, 0, 0 "},
    {"caveblackrock", "0 0 127 "},
    {"caveblackrock", "0 0 192 "},
    {"snow", "0 0 255 "}, /* wading depth */
    {"cmarsh",	    "12 161 64 "},
    {"cmarsh",  "155 175 164 "},
    {"snow",	    "0 255 0 "},
    {"snow",  "222 218 135 "},
    ...
    {"cforest2",	    "1 182 02 "},
    {"cforest3",     "4 153 02 "},
    {"caveblackrock",   "166 160 70 "},
    {"drifts", "166 155 70 "},
    {"s_mountain",    "150 97 34 "},
    {"mountain5",    "183 190 190 "},
    {"caveblackrock",   "191 196 185 "},
    {"caveblackrock",   "255 255 255 "},
};
