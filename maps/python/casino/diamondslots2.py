...
#Non Standard type Diamond Slots
...
minpot = 1000 #Minimum slot jackpot size
maxpot = 10000 #Maxiumum slot jackpot size
cost = 2 #Price of usage

#Change the items on the slot spinner or the number of items.
slotlist = ["silver", "silver", "silver", "silver", "doublesilver", "doublesilver", "doublesilver", "doublesilver", "quicksilver", "quicksilver", "quicksilver", "quicksilver", "Sapphire", "Sapphire", "Sapphire", "Emerald", "Emerald", "Emerald", "NavarianRoyal", "NavarianRoyal", "NavarianRoyal", "Diamond", "Diamond",  "DiamondDeluxe"]
    ...
    if (pay):
       ...
       for item in results:
          ...
          if results.count(item) == spinners-1:
             if item == "silver":
                pay = 1
             elif item == "doublesilver":
                pay = 2
             elif item == "quicksilver":
                pay = 3
             elif item == "Sapphire":
                pay = 4
             elif item == "Emerald":
                pay = 5
             elif item == "NavarianRoyal":
                pay = 6
             elif item == "Diamond":
                pay = 10
             elif item == "DiamondDeluxe":
                pay = 25
             else:
                break
